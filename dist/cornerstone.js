...
exports.default = function (element) {
  ...
  var verticalScale = enabledElement.canvas.height / imageSize.height / verticalRatio;
  var horizontalScale = enabledElement.canvas.width / imageSize.width / horizontalRatio;
...
exports.default = function (canvas, image) {
  ...
  // Fit image to window
  var verticalScale = canvas.height / image.rows / verticalRatio;
  var horizontalScale = canvas.width / image.columns / horizontalRatio;
